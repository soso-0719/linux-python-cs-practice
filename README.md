...
このリポジトリでは、Webアプリ開発だけに終わらず、Linux、Git、Python、C言語、メモリ、コンパイラ、API、DB、React/Next.js などを横断的に学んでいます。
...
この学習リポジトリで得た知識をもとに、次はポートフォリオとして見せやすいアプリ「Ai-Study-Grove」を開発段階です。最低限の機能は追加したので改良中です。

AI Study Groveでは、API設計、DB操作、Reactのstate管理に加えて、AIを使った学習支援機能を組み込みました。
